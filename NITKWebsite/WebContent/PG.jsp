...
<head>
    ...
    <link rel="stylesheet" media="screen and (max-width: 830px)" href="css/phone.css">
...
<body>
    ...
    <div class="sidebar">
        ...
        <section class="mtech">
            <div class="col">
                <div class="colrow1">
                    <h3>M.Tech(CSE) and M.Tech(CSE-IS)</h3>
                    <hr class="border">
                    <p>The department offers two post-graduate courses - M.Tech. in Computer Science and Engineering (CSE) and M.Tech in Computer Science and Engineering - Information Security (CSE-IS). </p>
                    <p>Admission through GATE -  as per guidelines of MHRD</p>
                    <p><a href="https://www.nitk.ac.in/Curriculum">M.Tech-Curriculum[2019]</a></p>
                    <p>Academic Calender:<a href="https://old.nitk.ac.in/academics/curriculum">M.Tech.[2020]</a></p>

                </div>
                <div class="colrow2">
                    <h3>M.Tech.(Computer Science and Engineering)</h3>
                    <hr class="border">
                    <p>The M.Tech.(CSE) is a four semester course and was started in 1996. The course is aimed at providing a comprehensive overview of the recent developments in various 
                        frontier areas of Computer Science and Engineering including Computer Architecture, Software Systems, Parallel and Distributed Computing and Networking with Web
                        Technologies. To provide a sound basis, sufficient amount of theoretical input is also given to the students. Another feature of the programme is that the students will have 
                        ample opportunity to carry out research & software development in the labs.</p>
                    <p>Average Intake (per year) : 27</p>
                </div>
                <div class="colrow1">
                    <h3>M.Tech.(Computer Science and Engineering- Information Security)</h3>
                    <hr class="border">
                    <p>M.Tech(CSE-IS) is a four semester course aimed to focus on the recent developments in the areas of Information Security. The course was offered for the first time 
                       in 2007. The curriculum for these P.G programmes has been carefully crafted to cater the need of those students who are admitted with their basic degree in computing. In 
                       other words, care is taken, not to repeat the same, good old courses of U.G in the P.G level.</p>
                    <p>Average Intake (per year) : 27</p>

                </div>
                <div class="colrow1">
                    <h3>M.Tech.(By Research)</h3>
                    <hr class="border">
                    <p>M.Tech (By Research) programme was started in 2011 and is aimed at students interested more in exposure to research in various fields of Computer Science & 
                       Engineering. It emphasizes research work, providing students a distinctive opportunity to undertake research work and innovation.</p>
                ...
                <div class="colrow1">
                    ...
                    <ol>
                        ...
                        <li> Pursue a successful career in industry/academia/research/government driven by strong foundations and in-depth domain knowledge and  contribute to the 
                            engineering sphere as a competent professional.</li>
                        ...
                        <li> Work effectively in multi-disciplinary and multi-cultural environments by respecting professionalism and ethical practices within organization and society at national 
                            and international level.</li>
                    </ol>
                ...
                <div class="colrow1">
                    ...
                    <ol>
                        ...
                        <li> Critically analyze existing literature in an area of specialization, conduct investigative research to develop innovative methodologies to tackle  issues identified and 
                             contribute to the development of technological knowledge and intellectual property.</li>
